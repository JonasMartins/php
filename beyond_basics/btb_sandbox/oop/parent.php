<?php
  /*
    O objetivo deste exemplo é que podemos 
    acessar tanto o método da classe pai como
    da classe atual depois de ser instanciada e
    e ver as duas saídas mesmo que o método tenha
    sido sobrescrito
  */ 
